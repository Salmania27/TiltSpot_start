...
public class MainActivity extends AppCompatActivity
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        float[] rotationMatric=new float[9];
        boolean rotationOK=SensorManager.getRotationMatrix(rotationMatric, null,
                mAccelerometerData, mMagnetometerData);
        float[] orientationValues=new float[3];
        if (rotationOK){
            SensorManager.getOrientation(rotationMatric, orientationValues);
        }
